...
async def get_gopay_dashboard_summary(
    ...
    payment_method: Optional[str] = Query(None, description="Filter metode pembayaran. Kosongkan untuk semua."),
    status: Optional[str] = Query(None, description="Filter status transaksi. Kosongkan untuk semua."),
    volume_min: Optional[float] = Query(None, description="Batas bawah total volume transaksi (harian per baris)."),
    volume_max: Optional[float] = Query(None, description="Batas atas total volume transaksi (harian per baris)."),
    cashback_min: Optional[float] = Query(None, description="Batas bawah total cashback dibakar."),
    cashback_max: Optional[float] = Query(None, description="Batas atas total cashback dibakar."),
):
    """
    ...
    filter_clause = _build_filter_clause(
        params, payment_method, status, volume_min, volume_max, cashback_min, cashback_max
    )
